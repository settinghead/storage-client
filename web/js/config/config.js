...
angular.module("common-config", [])
    ...
    .value("CORE_URL_TEST", "https://store-dot-rvacore-test.appspot.com/_ah/api")
    .value("CORE_URL_PRODUCTION", "https://store-dot-rvaserver2.appspot.com/_ah/api")
    .value("RVA_URL", "http://rdn-test.appspot.com/")
    .value("RVA_URL_TEST", "http://rdn-test.appspot.com/")
    .value("RVA_URL_PRODUCTION", "http://rvauser.appspot.com/")
;